...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
//nestedFunction has access to the variable internal 
//because nestedFunction is declared within the same scope internal is declared.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(){
    const newArr = zooAnimals.map(item => item.animal_name.toLowerCase());
    return newArr
  }
  ...
  */
  ...
  function USApop() {
    ...
    (previousValue, currentValue) => { return previousValue + currentValue.population}, 0);
  return sum
  }
